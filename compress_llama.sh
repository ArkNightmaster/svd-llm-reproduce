...
python SVDLLM.py --model /data/Llama-3 --step 1 --ratio 0.2 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path .
# python SVDLLM.py --model jeffwan/llama-7b-hf --step 1 --ratio 0.2 --whitening_nsamples 256 --dataset c4 --seed 3 --model_seq_len 2048 --save_path .
# python SVDLLM.py --model jeffwan/llama-7b-hf --step 1 --ratio 0.2 --whitening_nsamples 256 --dataset ptb --seed 3 --model_seq_len 2048 --save_path .
